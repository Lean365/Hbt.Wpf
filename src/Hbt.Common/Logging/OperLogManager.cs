...
public class OperLogManager : ILogManager
{
    ...
    public OperLogManager(ILogger logger)
    {
        // 确保 logs 目录存在
    ...
    /// 记录创建操作
    /// </summary>
    public void Create(string entityName, string entityId, string operatorName)
    {
    ...
    /// 记录更新操作
    /// </summary>
    public void Update(string entityName, string entityId, string operatorName, string changes = "")
    {
    ...
    /// 记录删除操作
    /// </summary>
    public void Delete(string entityName, string entityId, string operatorName)
    {
