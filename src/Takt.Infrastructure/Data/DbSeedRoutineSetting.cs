...
public class DbSeedRoutineSetting
{
    ...
    private static List<Setting> BuildSettingSeeds()
    {
        return new List<Setting>
        {
            ...
            // SystemInfo
            new Setting { SettingKey = "SystemInfo:SystemName", SettingValue = "节拍中后台管理平台", SettingDescription = "系统名称，显示在标题栏和应用标题位置", Category = "SystemInfo", SettingType = 0, OrderNum = 1, IsBuiltin = 0, IsEditable = 0, IsDefault = 1 },
