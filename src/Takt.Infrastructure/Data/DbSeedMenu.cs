...
public class DbSeedMenu
{
    ...
    public List<Menu> CreateSystemMenus()
    {
        ...
        if (logging != null)
        {
            ...
            // 17. 异常日志 - 使用完整方法创建
            var exceptionLogMenu = SafeCreateMenu("异常日志", () => CreateOrUpdateMenuComplete(
                ...
                component: "Takt.Fluent.Views.Logging.ExceptionLogView",
            ...
            if (exceptionLogMenu != null) menus.Add(exceptionLogMenu);
            ...
            var operationLogMenu = SafeCreateMenu("操作日志", () => CreateOrUpdateMenuComplete(
                ...
                component: "Takt.Fluent.Views.Logging.OperationLogView",
                icon: "PenToSquare",
                orderNum: 3,
                isExternal: ExternalEnum.NotExternal,
                isCache: CacheEnum.NoCache,
