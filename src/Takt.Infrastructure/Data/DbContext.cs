...
public class DbContext
{
    ...
    public DbContext(string connectionString, ILogger logger, HbtDatabaseSettings settings, ILogDatabaseWriter? logDatabaseWriter = null)
    {
        _logger = logger;
        _settings = settings;
        ...
        SqlSugarAop.ConfigureAop(_db, logger, settings, logDatabaseWriter);
    }
    ...
    public bool CheckConnection()
    {
        ...
        {
            _logger.Warning("数据库连接检查失败：{Message}", ex.Message);
            return false;
        }
    }
