...
{
    public override System.Windows.ThemeMode Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
    {
        ...
        else if (reader.TokenType == JsonTokenType.StartObject)
        {
            ...
            // 使用 JsonDocument 来解析整个对象，避免手动读取导致的位置错误
    ...
    public override void Write(Utf8JsonWriter writer, System.Windows.ThemeMode value, JsonSerializerOptions options)
    {
        string stringValue;
...
{
    [System.Text.Json.Serialization.JsonConverter(typeof(ThemeModeJsonConverter))]
