...
internal class LocValueConverter : IValueConverter
{
    ...
    public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
    {
        ...
        var baseText = _localizationAdapter.GetTranslation(_key, _key);
        ...
        {
            p0 = _localizationAdapter.GetTranslation(_param0Key!, _param0Key);
        }
        ...
        {
            p1 = _localizationAdapter.GetTranslation(_param1Key!, _param1Key);
        }
