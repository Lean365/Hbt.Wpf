...
// 文件名称：DictionaryTypeForm.xaml.cs
// 创建时间：2025-01-20
...
/// 字典类型表单窗口
/// </summary>
public partial class DictionaryTypeForm : Window
{
    private readonly ILocalizationManager? _localizationManager;
    private DictionaryTypeFormViewModel? _viewModel;

    /// <summary>
    /// 初始化字典类型表单窗口
    /// </summary>
    /// <param name="vm">字典类型表单视图模型</param>
    /// <param name="localizationManager">本地化管理器</param>
    public DictionaryTypeForm(DictionaryTypeFormViewModel vm, ILocalizationManager? localizationManager = null)
    {
        InitializeComponent();
    ...
    {
        // 统计字段数量：类型代码、类型名称、排序号、类型状态、备注 = 5个
        int normalFieldCount = 4; // 类型代码、类型名称、排序号、类型状态
        ...
        double totalHeight = normalFieldsHeight + remarksFieldHeight + normalFieldsSpacing + specialFieldsSpacing + stackPanelMargin;
