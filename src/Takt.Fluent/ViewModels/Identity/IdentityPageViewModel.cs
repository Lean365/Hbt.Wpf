...
public partial class IdentityPageViewModel : ObservableObject
{
    ...
    public IdentityPageViewModel(ILocalizationManager localizationManager, IMenuService? menuService = null)
    {
        ...
        if (menuService != null)
        {
            ...
            if (result.Success && result.Data != null)
            {
                ...
                if (menu != null)
                {
                    ...
                    var translatedTitle = _localizationManager.GetString(titleKey);
                    PageTitle = (translatedTitle == titleKey) ? menu.MenuName : translatedTitle;
                    ...
                    if (menu.Children != null)
                    {
                        ...
                        foreach (var childMenu in menu.Children.OrderBy(m => m.OrderNum))
                        {
                            ...
                            var translatedChildTitle = _localizationManager.GetString(childTitleKey);
                            NavigationCards.Add(new NavigationCard(
                                title: (translatedChildTitle == childTitleKey) ? childMenu.MenuName : translatedChildTitle,
                                description: null,
                                icon: childMenu.Icon,
                                menuItem: childMenu
                            ));
