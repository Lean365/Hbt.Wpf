...
/// 记录系统运行时的异常信息
/// </remarks>
[SugarTable("takt_logging_exception_log", "异常日志表")]
[SugarIndex("IX_takt_logging_exception_log_exception_type", nameof(ExceptionLog.ExceptionType), OrderByType.Asc, false)]
[SugarIndex("IX_takt_logging_exception_log_level", nameof(ExceptionLog.Level), OrderByType.Asc, false)]
[SugarIndex("IX_takt_logging_exception_log_exception_time", nameof(ExceptionLog.ExceptionTime), OrderByType.Desc, false)]
[SugarIndex("IX_takt_logging_exception_log_created_time", nameof(ExceptionLog.CreatedTime), OrderByType.Desc, false)]
