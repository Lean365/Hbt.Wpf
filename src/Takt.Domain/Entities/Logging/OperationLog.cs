...
/// 记录用户的业务操作行为
/// </remarks>
[SugarTable("takt_logging_operation_log", "操作日志表")]
[SugarIndex("IX_takt_logging_operation_log_username", nameof(OperationLog.Username), OrderByType.Asc, false)]
[SugarIndex("IX_takt_logging_operation_log_operation_type", nameof(OperationLog.OperationType), OrderByType.Asc, false)]
[SugarIndex("IX_takt_logging_operation_log_operation_module", nameof(OperationLog.OperationModule), OrderByType.Asc, false)]
[SugarIndex("IX_takt_logging_operation_log_operation_time", nameof(OperationLog.OperationTime), OrderByType.Desc, false)]
[SugarIndex("IX_takt_logging_operation_log_created_time", nameof(OperationLog.CreatedTime), OrderByType.Desc, false)]
public class OperationLog : BaseEntity
{
    ...
    /// 操作描述
    /// </summary>
    [SugarColumn(ColumnName = "operation_desc", ColumnDescription = "操作描述", ColumnDataType = "nvarchar", Length = 500, IsNullable = true)]
    ...
    /// 请求参数
    /// </summary>
    [SugarColumn(ColumnName = "request_params", ColumnDescription = "请求参数", ColumnDataType = "nvarchar", IsNullable = true)]
    public string? RequestParams { get; set; }

    /// <summary>
    /// 响应结果
    /// </summary>
    [SugarColumn(ColumnName = "response_result", ColumnDescription = "响应结果", ColumnDataType = "nvarchar", IsNullable = true)]
