...
/// 记录用户的业务操作行为
/// </remarks>
[SugarTable("hbt_logging_operation_log", "操作日志表")]
[SugarIndex("IX_hbt_logging_operation_log_username", nameof(OperationLog.Username), OrderByType.Asc, false)]
[SugarIndex("IX_hbt_logging_operation_log_operation_type", nameof(OperationLog.OperationType), OrderByType.Asc, false)]
[SugarIndex("IX_hbt_logging_operation_log_operation_module", nameof(OperationLog.OperationModule), OrderByType.Asc, false)]
[SugarIndex("IX_hbt_logging_operation_log_operation_time", nameof(OperationLog.OperationTime), OrderByType.Desc, false)]
[SugarIndex("IX_hbt_logging_operation_log_created_time", nameof(OperationLog.CreatedTime), OrderByType.Desc, false)]
