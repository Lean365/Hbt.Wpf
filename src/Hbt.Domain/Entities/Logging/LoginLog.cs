...
/// 记录用户登录、登出行为
/// </remarks>
[SugarTable("hbt_logging_login_log", "登录日志表")]
[SugarIndex("IX_hbt_logging_login_log_username", nameof(LoginLog.Username), OrderByType.Asc, false)]
[SugarIndex("IX_hbt_logging_login_log_login_time", nameof(LoginLog.LoginTime), OrderByType.Desc, false)]
[SugarIndex("IX_hbt_logging_login_log_login_status", nameof(LoginLog.LoginStatus), OrderByType.Asc, false)]
[SugarIndex("IX_hbt_logging_login_log_created_time", nameof(LoginLog.CreatedTime), OrderByType.Desc, false)]
public class LoginLog : BaseEntity
{
    ...
    /// 浏览器/客户端
    /// </summary>
    [SugarColumn(ColumnName = "browser", ColumnDescription = "浏览器客户端", ColumnDataType = "nvarchar", Length = 100, IsNullable = true)]
