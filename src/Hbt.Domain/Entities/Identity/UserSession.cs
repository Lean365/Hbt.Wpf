...
/// 记录用户登录会话信息，支持多用户并发
/// </remarks>
[SugarTable("hbt_oidc_user_session", "用户会话表")]
[SugarIndex("IX_hbt_oidc_user_session_session_id", nameof(UserSession.SessionId), OrderByType.Asc, true)]
[SugarIndex("IX_hbt_oidc_user_session_user_id", nameof(UserSession.UserId), OrderByType.Asc, false)]
[SugarIndex("IX_hbt_oidc_user_session_expires_at", nameof(UserSession.ExpiresAt), OrderByType.Desc, false)]
[SugarIndex("IX_hbt_oidc_user_session_is_active", nameof(UserSession.IsActive), OrderByType.Asc, false)]
