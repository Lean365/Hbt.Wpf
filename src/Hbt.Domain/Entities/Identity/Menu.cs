...
/// </remarks>
[SugarTable("hbt_oidc_menu", "菜单表")]
[SugarIndex("IX_hbt_oidc_menu_menu_code", nameof(Menu.MenuCode), OrderByType.Asc, true)]
[SugarIndex("IX_hbt_oidc_menu_parent_id", nameof(Menu.ParentId), OrderByType.Asc, false)]
[SugarIndex("IX_hbt_oidc_menu_menu_type", nameof(Menu.MenuType), OrderByType.Asc, false)]
[SugarIndex("IX_hbt_oidc_menu_status", nameof(Menu.MenuStatus), OrderByType.Asc, false)]
public class Menu : BaseEntity
{
    ...
    /// </remarks>
    [SugarColumn(ColumnName = "menu_code", ColumnDescription = "菜单编码", ColumnDataType = "nvarchar", Length = 100, IsNullable = false)]
    ...
    /// </remarks>
    [SugarColumn(ColumnName = "i18n_key", ColumnDescription = "国际化键", ColumnDataType = "nvarchar", Length = 200, IsNullable = true)]
    ...
    /// </remarks>
    [SugarColumn(ColumnName = "perm_code", ColumnDescription = "权限码", ColumnDataType = "nvarchar", Length = 100, IsNullable = true)]
