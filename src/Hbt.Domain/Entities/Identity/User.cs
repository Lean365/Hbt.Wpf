...
/// </summary>
[SugarTable("hbt_oidc_user", "用户表")]
[SugarIndex("IX_hbt_oidc_user_username", nameof(User.Username), OrderByType.Asc, true)]
[SugarIndex("IX_hbt_oidc_user_email", nameof(User.Email), OrderByType.Asc, false)]
[SugarIndex("IX_hbt_oidc_user_phone", nameof(User.Phone), OrderByType.Asc, false)]
[SugarIndex("IX_hbt_oidc_user_user_type", nameof(User.UserType), OrderByType.Asc, false)]
[SugarIndex("IX_hbt_oidc_user_status", nameof(User.UserStatus), OrderByType.Asc, false)]
