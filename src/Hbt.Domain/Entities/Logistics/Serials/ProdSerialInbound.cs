...
/// 记录序列号的入库信息
/// </summary>
[SugarTable("hbt_logistics_prod_serial_inbound", "产品序列号入库记录表")]
[SugarIndex("IX_hbt_logistics_prod_serial_inbound_full_serial_number", nameof(ProdSerialInbound.FullSerialNumber), OrderByType.Asc, false)]
[SugarIndex("IX_hbt_logistics_prod_serial_inbound_material_code", nameof(ProdSerialInbound.MaterialCode), OrderByType.Asc, false)]
[SugarIndex("IX_hbt_logistics_prod_serial_inbound_inbound_no", nameof(ProdSerialInbound.InboundNo), OrderByType.Asc, false)]
[SugarIndex("IX_hbt_logistics_prod_serial_inbound_inbound_date", nameof(ProdSerialInbound.InboundDate), OrderByType.Desc, false)]
[SugarIndex("IX_hbt_logistics_prod_serial_inbound_created_time", nameof(ProdSerialInbound.CreatedTime), OrderByType.Desc, false)]
public class ProdSerialInbound : BaseEntity
{
    ...
    /// 入库员
    /// </summary>
    [SugarColumn(ColumnName = "operator", ColumnDescription = "入库员", ColumnDataType = "nvarchar", Length = 50, IsNullable = true)]
