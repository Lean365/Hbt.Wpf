...
/// 基于SAP物料主数据标准的生产物料信息
/// </summary>
[SugarTable("hbt_logistics_prod_material", "生产物料表")]
[SugarIndex("IX_hbt_logistics_prod_material_material_code", nameof(ProdMaterial.MaterialCode), OrderByType.Asc, true)]
[SugarIndex("IX_hbt_logistics_prod_material_material_type", nameof(ProdMaterial.MaterialType), OrderByType.Asc, false)]
[SugarIndex("IX_hbt_logistics_prod_material_material_group", nameof(ProdMaterial.MaterialGroup), OrderByType.Asc, false)]
[SugarIndex("IX_hbt_logistics_prod_material_plant", nameof(ProdMaterial.Plant), OrderByType.Asc, false)]
[SugarIndex("IX_hbt_logistics_prod_material_created_time", nameof(ProdMaterial.CreatedTime), OrderByType.Desc, false)]
