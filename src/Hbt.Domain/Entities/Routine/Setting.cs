...
/// 用于存储系统级别的配置参数
/// </summary>
[SugarTable("hbt_routine_setting", "系统设置表")]
[SugarIndex("IX_hbt_routine_setting_key", nameof(SettingKey), OrderByType.Asc, true)]
[SugarIndex("IX_hbt_routine_setting_category", nameof(Category), OrderByType.Asc, false)]
