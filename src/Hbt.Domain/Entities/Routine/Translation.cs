...
/// 用于存储多语言翻译内容
/// </summary>
[SugarTable("hbt_routine_translation", "翻译表")]
[SugarIndex("IX_hbt_routine_translation_language_code", nameof(LanguageCode), OrderByType.Asc, false)]
[SugarIndex("IX_hbt_routine_translation_key", nameof(TranslationKey), OrderByType.Asc, false)]
[SugarIndex("IX_hbt_routine_translation_module", nameof(Module), OrderByType.Asc, false)]
[SugarIndex("IX_hbt_routine_translation_composite", nameof(TranslationKey), OrderByType.Asc, nameof(LanguageCode), OrderByType.Asc, true)]
